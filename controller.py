...
def writeRules (p4info_helper, ingress_sw, dst_eth_addr, dst_ip_addr,port):
	...
	table_entry = p4info_helper.buildTableEntry(
		...
		action_params = {
			"dstAddr" : (dst_eth_addr,48),
			"port" : port
		})
	ingress_sw.WriteTableRules(table_entry)
...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        writeRules(p4info_helper, ingress_sw=s2,
                         dst_eth_addr="08:00:00:00:02:22", dst_ip_addr="10.0.2.2",port = 1)
        writeRules(p4info_helper, ingress_sw=s2,
